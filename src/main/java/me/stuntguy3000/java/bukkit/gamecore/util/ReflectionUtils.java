...
public final class ReflectionUtils {
     ...
     *                                   constructor (this should not occur since it searches for a constructor with the
     ...
     * @throws InvocationTargetException If the desired constructor cannot be invoked
     * @throws NoSuchMethodException     If the desired constructor with the specified arguments cannot be found
     * @throws ClassNotFoundException    If the desired target class with the specified name and package cannot be
     *                                   found
     * @see #getClass(String, PackageType)
     ...
     * @throws NoSuchMethodException     If the desired method of the class of the target object with the specified name
